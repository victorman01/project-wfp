...
<body>
      ...
      <nav class="navbar navbar-expand-lg center-nav transparent navbar-light">
        <div class="container flex-lg-row flex-nowrap align-items-center">
          <div class="navbar-brand w-100">
            <a href="../../index.html">
              <img src="{{asset('sandbox360/img/logo.png')}}" srcset="{{asset('sandbox360/img/logo@2x.png')}} 2x" alt="" />
            </a>
          </div>
                    ...
                    <li class="mega-menu-content mega-menu-scroll">
                      <ul class="row row-cols-1 row-cols-lg-6 gx-0 gx-lg-4 gy-lg-2 list-unstyled">
                        <li class="col"><a class="dropdown-item" href="../../demo1.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi1.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi1@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo I</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo2.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi2.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi2@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo II</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo3.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi3.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi3@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo III</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo4.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi4.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi4@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo IV</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo5.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi5.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi5@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo V</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo6.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi6.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi6@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo VI</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo7.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi7.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi7@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo VII</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo8.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi8.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi8@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo VIII</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo9.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi9.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi9@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo IX</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo10.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi10.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi10@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo X</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo11.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi11.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi11@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XI</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo12.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi12.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi12@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XII</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo13.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi13.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi13@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XIII</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo14.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi14.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi14@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XIV</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo15.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi15.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi15@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XV</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo16.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi16.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi16@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XVI</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo17.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi17.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi17@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XVII</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo18.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi18.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi18@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XVIII</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo19.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi19.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi19@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XIX</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo20.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi20.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi20@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XX</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo21.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi21.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi21@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XXI</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo22.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi22.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi22@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XXII</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo23.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi23.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi23@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XXIII</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo24.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi24.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi24@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XXIV</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo25.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi25.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi25@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XXV</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo26.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi26.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi26@2x.jpg')}} 2x" alt=""></figure>
                            <span class="d-lg-none">Demo XXVI</span>
                          </a></li>
                        <li class="col"><a class="dropdown-item" href="../../demo27.html">
                            <figure class="rounded lift d-none d-lg-block"><img src="{{asset('sandbox360/img/demos/mi27.jpg')}}" srcset="{{asset('sandbox360/img/demos/mi27@2x.jpg')}} 2x" alt=""></figure>
                    ...
                    <li class="mega-menu-content">
                      <ul class="row row-cols-1 row-cols-lg-6 gx-0 gx-lg-6 gy-lg-4 list-unstyled">
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/about.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block1.svg')}}" alt=""></div>
                            <span>About</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/blog.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block2.svg')}}" alt=""></div>
                            <span>Blog</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/call-to-action.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block3.svg')}}" alt=""></div>
                            <span>Call to Action</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/clients.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block4.svg')}}" alt=""></div>
                            <span>Clients</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/contact.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block5.svg')}}" alt=""></div>
                            <span>Contact</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/facts.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block6.svg')}}" alt=""></div>
                            <span>Facts</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/faq.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block7.svg')}}" alt=""></div>
                            <span>FAQ</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/features.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block8.svg')}}" alt=""></div>
                            <span>Features</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/footer.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block9.svg')}}" alt=""></div>
                            <span>Footer</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/hero.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block10.svg')}}" alt=""></div>
                            <span>Hero</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/misc.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block17.svg')}}" alt=""></div>
                            <span>Misc</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/navbar.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block11.svg')}}" alt=""></div>
                            <span>Navbar</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/portfolio.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block12.svg')}}" alt=""></div>
                            <span>Portfolio</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/pricing.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block13.svg')}}" alt=""></div>
                            <span>Pricing</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/process.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block14.svg')}}" alt=""></div>
                            <span>Process</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/team.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block15.svg')}}" alt=""></div>
                            <span>Team</span>
                          </a>
                        </li>
                        <li class="col"><a class="dropdown-item" href="../../docs/blocks/testimonials.html">
                            <div class="rounded img-svg d-none d-lg-block p-4 mb-lg-2"><img class="rounded-0" src="{{asset('sandbox360/img/demos/block16.svg')}}" alt=""></div>
  ...
  <section class="wrapper bg-dark text-white">
    <div class="container pt-14 pt-md-16 text-center">
      ...
      <!-- /.row -->
      <img class="img-fluid" src="{{asset('sandbox360/img/demos/f1.png')}}" srcset="{{asset('sandbox360/img/demos/f1@2x.png')}} 2x" alt="" />
    </div>
    <!-- /.container -->
  </section>
  <!-- /section -->
