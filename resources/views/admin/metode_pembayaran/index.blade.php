...
<div class="container">
    ...
    <p><a href="/admin/metode_pembayarans/create">Create New Metode Pembayaran</a></p>
        ...
        <tbody>
            @foreach ($metode_pembayarans as $metode_pembayaran)
                <tr>
                    ...
                    <td>
                        <p><a class="btn btn-primary btn-block" href="/admin/metode_pembayarans/{{ $metode_pembayaran->id }}/edit">Edit <i class="fa fa-edit"></i></a></p>
                        <form action="/admin/metode_pembayarans/{{ $metode_pembayaran->id }}" method="POST" class='d-inline'>
                            @method('DELETE')
                            @csrf
