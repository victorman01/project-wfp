...
<div class="container">
    ...
    <p><a href="/admin/gambars/create">Create New Gambar</a></p>
        ...
        <tbody>
            @foreach ($gambars as $gambar)
                <tr>
                    ...
                    <td>
                        <p><a class="btn btn-primary btn-block" href="/admin/gambars/{{ $gambar->id }}/edit">Edit <i class="fa fa-edit"></i></a></p>
