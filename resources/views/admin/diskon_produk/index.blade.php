...
<div class="container">
    ...
    <p><a href="/admin/diskon_produks/create">Create New Diskon Produk</a></p>
        ...
        <tbody>
            @foreach ($diskonProduks as $diskonProduk)
                <tr>
                    ...
                    <td>
                        <p><a class="btn btn-primary btn-block" href="/admin/diskon_produks/{{ $diskonProduk->id }}/edit">Edit <i class="fa fa-edit"></i></a></p>
                        <form action="/admin/diskon_produks/{{ $diskonProduk->id }}" method="POST" class='d-inline'>
                            @method('DELETE')
                            @csrf
